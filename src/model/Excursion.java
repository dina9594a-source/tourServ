...
public class Excursion extends TourService {
    ...
    public String toString() {
        return "User{Где экскурсия=\"" + where + "\", Сколько дней экскурсия=\"" + day + "\", Name=\"" + getName() + "\", From=\"" + getFrom() + "\", To=\"" + getTo() + "\", Price=\"" + getPrice() + "\"}";
    }
    ...
    public Excursion( String name, BigDecimal price, LocalDate from, LocalDate to, String where, int day) {
